...
Public Class Cls_NotaDebitoXML
    ...
    Public Function CreateInvoice(filename As String, Ruc As String, ByVal Oversion As String, OCustomId As String, OComprobante As String, OFEmsion As DateTime,
        ...
        With Cabecera.Rows(0)
            ...
            Else
                ...
                'Invoice.RequestedMonetaryTotal 
            End If
...
#End Region
    ...
    Private Function DetalleItem(item As Integer, ByVal datos As DataTable) As DebitNoteLineType()
        ...
        Return InvoiceItem
    End Function
    Private Function DetalleFactura(item As Integer, d As DataRow) As DebitNoteLineType
        Dim InvoiceLine1 As New DebitNoteLineType
        Dim InvoicedQuantity As New DebitedQuantityType
        ...
        ID.Value = item
        InvoiceLine1.ID = ID
        InvoiceLine1.DebitedQuantity = InvoicedQuantity
