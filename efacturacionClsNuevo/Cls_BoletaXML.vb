...
Public Class Cls_BoletaXML
    ...
    Public Function CreateInvoice(filename As String, Ruc As String, ByVal Oversion As String, OCustomId As String, OComprobante As String, OFEmsion As DateTime,
        ...
        'myNamespaces.Add("rsc", "urn:rsc:names:specification:ubl:peru:schema:xsd:RscAggregateComponents-1") ' agregado
        ...
        With Cabecera.Rows(0)
            ...
            '''' Rodrigo
            'ubl_1(1) = UBLExtensionTypeDatosGenerales()
            ''''
        ...
        Return ms.ToArray
    End Function
    Public Function UBLExtensionTypeDatosGenerales() As UBLExtensionType
        Dim extension As New UBLExtensionType
        Dim DatoAdicional As New DatoAdicionalType
        DatoAdicional.codigo = "0001"
        DatoAdicional.value = "Motor"
        Dim cabecera As New CabeceraType
        cabecera.DatoAdicional = DatoAdicional
        Dim DatosAdicionales As New DatosAdicionalesType
        DatosAdicionales.Cabecera = cabecera
        extension.ExtensionContent(0).DatosAdicionales = DatosAdicionales
