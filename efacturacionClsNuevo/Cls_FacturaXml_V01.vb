...
Public Class Cls_FacturaXml_V01
...
#End Region
    ...
    Private Function GetTaxCategory(ByVal Idx As String, Nam_Tax As String, Code_Tax As String, TaxExcepcionCode As String, tipo_impuesto As String, PercentIGV As Decimal, Optional isdetalle As Boolean = True) As TaxCategoryType
        ...
        Return TaxCategory
    End Function
    Private Function GetTaxCategory_ICBPER(ByVal Idx As String, Nam_Tax As String, Code_Tax As String, TaxExcepcionCode As String, tipo_impuesto As String, PercentIGV As Decimal, Optional isdetalle As Boolean = True) As TaxCategoryType
    ...
    Private Function Tax_SubImpuesto(ByVal ValorVenta As Decimal, ByVal Tax_SubImporte As Decimal, ByVal IdTax As String, Tax_Name As String, Tax_cod As String, taxExcepCod As String, PercentIGV As Decimal, tax_cate As String, Optional isdetalle As Boolean = True) As TaxSubtotalType
        ...
        Return TaxSubtotal
    End Function
    Private Function Tax_SubImpuesto_ICBPER(ByVal ValorVenta As Decimal, ByVal Tax_SubImporte As Decimal, ByVal IdTax As String, Tax_Name As String, Tax_cod As String, taxExcepCod As String, PercentIGV As Decimal, tax_cate As String, Optional isdetalle As Boolean = True) As TaxSubtotalType
        Dim TaxSubtotal As New TaxSubtotalType
        Dim TaxAmount As New TaxAmountType
        Dim BaseUnitMeasure As New BaseUnitMeasureType
        BaseUnitMeasure.Value = 4
        BaseUnitMeasure.unitCode = "NIU"
        TaxAmount.currencyID = ls_TipoMoneda
        TaxSubtotal.BaseUnitMeasure = BaseUnitMeasure
        TaxAmount.Value = Tax_SubImporte
        TaxSubtotal.TaxAmount = TaxAmount
        TaxSubtotal.TaxCategory = GetTaxCategory_ICBPER(IdTax, Tax_Name, Tax_cod, taxExcepCod, tax_cate, PercentIGV, isdetalle)
    ...
    Private Function DetalleFactura(item As Integer, d As DataRow, idplaca As String) As InvoiceLineType
        ...
        'End If
        pricecode1(0) = PrecioUnitario(PriceTypeCode, CType(d.Item("PrecioVenta"), Decimal).ToString("#.00"))
